...
const ROUTE_PERMISSIONS: Array<{ prefix: string; roles: UserRole[]; description: string }> = [
  ...
  { prefix: "/portal/customers/new", roles: ["SUPER_ADMIN", "OWNER", "BRANCH_MANAGER"], description: "Customer KYC Registration" },
  { prefix: "/portal/customers", roles: ["SUPER_ADMIN", "OWNER", "BRANCH_MANAGER"], description: "Customer KYC Directory" },
